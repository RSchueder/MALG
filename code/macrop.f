     ...
     +                        NOQ3   , NOQ4   )
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS: 'MACROP' :: MACROP
C
C*******************************************************************************
C
      IMPLICIT NONE
      ...
      DO 9000 ISEG = 1 , NOSEG
         ...
         IF (IKMRK1.EQ.1) THEN
            ...
            IF ((IKMRK2.EQ.0).OR.(IKMRK2.EQ.3)) THEN
               ...
               IF ( ABS(FrPOC1EM01+FrPOC2EM01+FrPOC3EM01-1.) .GT. 0.01 ) THEN
                  CALL DHERR2('sum fraction POC emerged macrophytes',FrPOC1EM01+FrPOC2EM01+FrPOC3EM01,ISEG,'MACROP')
               ELSE
                  FrPOC1EM01 = 1.0 - FrPOC2EM01 - FrPOC3EM01
               ENDIF

               IF ( ABS(FrPOC1SM01+FrPOC2SM01+FrPOC3SM01-1.) .GT. 0.01 ) THEN
                  CALL DHERR2('sum fraction POC submerged macrophytes',FrPOC1SM01+FrPOC2SM01+FrPOC3SM01,ISEG,'MACROP')
               ELSE
               ...
               dPrPOC1M01 = (dDecayEM01-dCtEMtRH01)*FrPOC1EM01 + (dDecaySM01-dCtSMtRH01)*FrPOC1SM01
               dPrPOC2M01 = (dDecayEM01-dCtEMtRH01)*FrPOC2EM01 + (dDecaySM01-dCtSMtRH01)*FrPOC2SM01
               dPrPOC3M01 = (dDecayEM01-dCtEMtRH01)*FrPOC3EM01 + (dDecaySM01-dCtSMtRH01)*FrPOC3SM01

               dPrPON1M01 = (dDecayEM01*NCRatEM01-dNtEMtRH01)*FrPOC1EM01 + (dDecaySM01*NCRatSM01-dNtSMtRH01)*FrPOC1SM01
               dPrPON2M01 = (dDecayEM01*NCRatEM01-dNtEMtRH01)*FrPOC2EM01 + (dDecaySM01*NCRatSM01-dNtSMtRH01)*FrPOC2SM01
               dPrPON3M01 = (dDecayEM01*NCRatEM01-dNtEMtRH01)*FrPOC3EM01 + (dDecaySM01*NCRatSM01-dNtSMtRH01)*FrPOC3SM01

               dPrPOP1M01 = (dDecayEM01*PCRatEM01-dPtEMtRH01)*FrPOC1EM01 + (dDecaySM01*PCRatSM01-dPtSMtRH01)*FrPOC1SM01
               dPrPOP2M01 = (dDecayEM01*PCRatEM01-dPtEMtRH01)*FrPOC2EM01 + (dDecaySM01*PCRatSM01-dPtSMtRH01)*FrPOC2SM01
               dPrPOP3M01 = (dDecayEM01*PCRatEM01-dPtEMtRH01)*FrPOC3EM01 + (dDecaySM01*PCRatSM01-dPtSMtRH01)*FrPOC3SM01
               ...
               dNH4upEM01 = (dGrowEM01 * NCratEM01 - dNtRHtEM01) * FrNH4EM01
               dNO3upEM01 = (dGrowEM01 * NCratEM01 - dNtRHtEM01) * FrNO3EM01
